...
public class SystemTestCaHolder {
    ...
    public void prepareCustomSecretsFromBundles(final String namespaceName, final String clusterName) {
        ...
        try {
            LOGGER.info("Deploy Certificate authority ({}-{}) for Kafka cluster: {} in namespace: {} and create associated Secrets",
                this.caCertSecretName, this.caKeySecretName, clusterName, namespaceName);
